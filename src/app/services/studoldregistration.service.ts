...
export class StudoldregistrationService {
  ...
  edit(id: number,data: Studoldregistration): Observable<any>{
    return this._http.put<Studoldregistration>(`${this.baseUrl}/studregistration/edit/${id}`, data)
  }

  delete(id: number): Observable<Studoldregistration>{
    return this._http.delete<Studoldregistration>(`${this.baseUrl}/studregistration/delete/`+id)
  }
}
