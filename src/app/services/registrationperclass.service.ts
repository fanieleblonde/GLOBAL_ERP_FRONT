...
export class RegistrationperclassService {
  ...
  getStregistrationList(): Observable<Registrationperclass[]>{
    return this._http.get<Registrationperclass[]>(`${this.baseUrl}/studregistration/get`)
  }
  ...
  edit(id: number,data: Registrationperclass): Observable<any>{
    return this._http.put<Registrationperclass>(`${this.baseUrl}/studregistration/edit/${id}`, data)
  }
