...
import {DegreeAddEditComponent} from "./degree-add-edit/degree-add-edit.component";
...
export class DegreeComponent {
  ...
  getDegreeList(){
    this._degreeService.getList().subscribe({
      next: (res: any) => {
        this.degree = res['hydra:member'];
        console.log(this.degree);

        this.dataSource = new MatTableDataSource(this.degree)
  ...
  openAddForm() {
    const dialogRef = this._modalService.open(DegreeAddEditComponent, {
      data: { title: 'degree Modal' },
  ...
  delete(id:number){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this._degreeService.delete(id).subscribe({
          next:(res) => {
            Swal.fire(
              'Deleted!',
