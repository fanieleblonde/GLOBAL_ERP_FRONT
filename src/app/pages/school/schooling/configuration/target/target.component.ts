...
import { TargetAddEditComponent } from './target-add-edit/target-add-edit.component';
...
export class TargetComponent {
  ...
  getList(){
    this._targetService.getTargetList().subscribe({
      next: (res: any) => {
        this.target = res['hydra:member'];
  ...
  openAddForm() {
    const dialogRef = this._modalService.open(TargetAddEditComponent, {
      data: { title: 'Target Modal' },
  ...
  delete(id:number){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this._targetService.delete(id).subscribe({
          next:(res) => {
            Swal.fire(
              'Deleted!',
