...
@Component({
  selector: 'app-class-and-room-add-edit',
  templateUrl: './class-and-room-add-edit.component.html',
  styleUrls: ['./class-and-room-add-edit.component.scss']
})
export class ClassAndRoomAddEditComponent {
  ...
  constructor(private _fb: FormBuilder,
              ...
              private _dialogRef: MdbModalRef<ClassAndRoomAddEditComponent>,
