...
import {ClassAndRoomAddEditComponent} from "./class-and-room-add-edit/class-and-room-add-edit.component";
import {UserService} from "../../../services/user.service";

@Component({
  selector: 'app-class-and-room',
  templateUrl: './class-and-room.component.html',
  styleUrls: ['./class-and-room.component.scss']
})
export class ClassAndRoomComponent {
