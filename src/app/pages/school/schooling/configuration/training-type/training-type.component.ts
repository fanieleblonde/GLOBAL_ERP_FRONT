...
export class TrainingTypeComponent {
  ...
  getList(){
    this._trainingTypeService.getTrainingTypeList().subscribe({
      next: (res: any) => {
        this.trainingType = res['hydra:member'];
        console.log(this.trainingType);

        this.dataSource = new MatTableDataSource(this.trainingType)
  ...
  openAddForm() {
    const dialogRef = this._modalService.open(TrainingTypeAddEditComponent, {
      data: { title: 'TrainingType Modal' },
  ...
  delete(id:number){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this._trainingTypeService.delete(id).subscribe({
          next:(res) => {
            Swal.fire(
              'Deleted!',
