...
import { SexAddEditComponent } from './sex-add-edit/sex-add-edit.component';
...
export class SexComponent {
  ...
  public sex!: Sex[];
  dataSource!: MatTableDataSource<Sex>;
  ...
  getList(){
    this._sexService.getList().subscribe({
      next: (res: any) => {
        this.sex = res['hydra:member'];
        console.log(this.sex);

        this.dataSource = new MatTableDataSource(this.sex)
  ...
  openAddForm() {
    const dialogRef = this._modalService.open(SexAddEditComponent, {
      data: { title: 'Sex Modal' },
  ...
  delete(id:number){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this._sexService.delete(id).subscribe({
          next:(res) => {
            Swal.fire(
              'Deleted!',
