...
@Component({
  selector: 'app-registrationperclass-edit',
  templateUrl: './registrationperclass-edit.component.html',
  styleUrls: ['./registrationperclass-edit.component.scss']
})
export class RegistrationperclassEditComponent {
  ...
  constructor(private _fb: FormBuilder,
              ...
              private _dialogRef: MdbModalRef<RegistrationperclassEditComponent>,
