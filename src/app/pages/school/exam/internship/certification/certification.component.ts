...
import {CertificationAddEditComponent} from "./certification-add-edit/certification-add-edit.component";
...
export class CertificationComponent {
  ...
  getList(){
    this._certificationService.getList().subscribe({
      next: (res: any) => {
        this.certification = res['hydra:member'];
        console.log(this.certification);

        this.dataSource = new MatTableDataSource(this.certification)
  ...
  openAddForm() {
    const dialogRef = this._modalService.open(CertificationAddEditComponent, {
      data: { title: 'certification Modal' },
  ...
  delete(id:number){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this._certificationService.delete(id).subscribe({
          next:(res) => {
            Swal.fire(
              'Deleted!',
