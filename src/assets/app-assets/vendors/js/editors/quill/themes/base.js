...
class BaseTooltip extends Tooltip {
  ...
  edit(mode = 'link', preview = null) {
    ...
    } else if (mode !== this.root.getAttribute('data-mode.ts')) {
      this.textbox.value = '';
    }
    this.position(this.quill.getBounds(this.quill.selection.savedRange));
    this.textbox.select();
    this.textbox.setAttribute('placeholder', this.textbox.getAttribute(`data-${mode}`) || '');
    this.root.setAttribute('data-mode.ts', mode);
  }
  ...
  save() {
    ...
    switch(this.root.getAttribute('data-mode.ts')) {
      case 'link':
        let scrollTop = this.quill.root.scrollTop;
        if (this.linkRange) {
      ...
      case 'formula':
        ...
        if (range != null) {
          this.quill.insertEmbed(index, this.root.getAttribute('data-mode.ts'), value, Emitter.sources.USER);
          if (this.root.getAttribute('data-mode.ts') === 'formula') {
